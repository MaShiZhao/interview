...
public class ActivityActivity extends BaseActivity
{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        String contentString = "activity中 onResume  执行完 才会显示出画面 所以前一页面的onStop才执行 \n" +
                ...
                ".002  ThreadActivity onStart\n" +
                ".006  ThreadActivity onResume\n" +
                ":17.672  ThreadActivity onPause\n" +
                ":17.728  CodeActivity onStart\n" +
                ":17.732  CodeActivity  onResume\n" +
                ":18.318  ThreadActivity onStop\n" +
                ":43.931  CodeActivity onPause\n" +
                ":43.954  ThreadActivity onRestart\n" +
                ":43.955  ThreadActivity onStart\n" +
                ":43.956  ThreadActivity onResume\n" +
                ":44.435  CodeActivity onStop\n" +
                ":44.436  CodeActivity onDestroy\n" +
                "\n\n\n" +
                "service" +
                "onCreat()\t创建服务\n" +
                "onStartCommand()\t开始服务\n" +
